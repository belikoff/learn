 ...
 */
class Version20160125114400 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, update_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, title VARCHAR(150) NOT NULL, slug VARCHAR(255) NOT NULL, body LONGTEXT NOT NULL, INDEX IDX_5A8A6C8DF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
