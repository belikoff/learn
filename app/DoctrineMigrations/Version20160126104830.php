 ...
 */
class Version20160126104830 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE post ADD keywords VARCHAR(255) NOT NULL, ADD description VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE post DROP keywords, DROP description');
    }
}
