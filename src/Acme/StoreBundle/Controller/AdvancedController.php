...
class AdvancedController extends Controller{
    ...
    defaults: {_controller: AcmeStoreBundle:Advanced:advanced}
    requirements:
        culture: ru|en
        year: \d+
        _format: html|php
     * http://symtest/app_dev.php/acme/advanced/1977/ru/foo.php
    ...
    public function advancedAction($_controller, $year, Request $Request){
         ...
         */
        $url = $this->get('router')->generate('acme_store_advanced', array(
            'year' => '1955', 
            'culture' => 'en',
            'title' => 'ok',
            '_format' => 'html',
