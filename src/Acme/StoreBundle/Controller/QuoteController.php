...
use Acme\StoreBundle\Form\QuoteType;
...
class QuoteController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $dumer = new VarDumper();
        //$quotes = $em->getRepository('AcmeStoreBundle:Quote')->findAll();

        $dql   = "SELECT q, a FROM AcmeStoreBundle:Quote q JOIN q.author a";
    ...
    public function getRamdomQuoteAction(Request $request)
    {
        ...
        $quote = $em->getRepository('AcmeStoreBundle:Quote')->getRandom($id);
        //$dumper = new VarDumper();
        //$dumper->dump($quote);
        return $this->render('AcmeStoreBundle::quoteBlock.html.twig',['quote' => $quote]);
    }
    ...
    {
        $quote = new Quote();
        $form = $this->createForm('Acme\StoreBundle\Form\QuoteType', $quote);
    ...
    {
        $deleteForm = $this->createDeleteForm($quote);
        $editForm = $this->createForm('Acme\StoreBundle\Form\QuoteType', $quote);
