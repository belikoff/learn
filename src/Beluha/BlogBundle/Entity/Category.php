...
class Category
{
     ...
     * Add child
     *
     * @param \Beluha\BlogBundle\Entity\Category $child
     *
     * @return Category
     */
    public function addChild(\Beluha\BlogBundle\Entity\Category $child)
    {
        $this->children[] = $child;
     ...
     * @param \Beluha\BlogBundle\Entity\Category $child
     */
    public function removeChild(\Beluha\BlogBundle\Entity\Category $child)
    {
