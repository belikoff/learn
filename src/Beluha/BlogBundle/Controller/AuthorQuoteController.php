...
use Beluha\BlogBundle\Form\AuthorQuoteType;
...
class AuthorQuoteController extends Controller
{
    ...
    {
        $author = $this->getDoctrine()->getRepository('BeluhaBlogBundle:AuthorQuote')->find($id);
    ...
    public function indexAction()
    {
        ...
        $authorQuotes = $em->getRepository('BeluhaBlogBundle:AuthorQuote')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Beluha\BlogBundle\Form\AuthorQuoteType', $authorQuote);
    ...
    {
        $deleteForm = $this->createDeleteForm($authorQuote);
        $editForm = $this->createForm('Beluha\BlogBundle\Form\AuthorQuoteType', $authorQuote);
