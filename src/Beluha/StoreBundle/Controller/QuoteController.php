...
use Beluha\StoreBundle\Form\QuoteType;
...
class QuoteController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $dumer = new VarDumper();
        //$quotes = $em->getRepository('BeluhaStoreBundle:Quote')->findAll();

        $dql   = "SELECT q, a FROM BeluhaStoreBundle:Quote q JOIN q.author a";
    ...
    public function getRamdomQuoteAction(Request $request)
    {
        ...
        $quote = $em->getRepository('BeluhaStoreBundle:Quote')->getRandom($id);
        //$dumper = new VarDumper();
        //$dumper->dump($quote);
        return $this->render('BeluhaStoreBundle::quoteBlock.html.twig',['quote' => $quote]);
    }
    ...
    {
        $quote = new Quote();
        $form = $this->createForm('Beluha\StoreBundle\Form\QuoteType', $quote);
    ...
    {
        $deleteForm = $this->createDeleteForm($quote);
        $editForm = $this->createForm('Beluha\StoreBundle\Form\QuoteType', $quote);
